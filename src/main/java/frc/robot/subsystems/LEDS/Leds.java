...
public class Leds extends SubsystemBase {
  ...
  public Leds() {
    ...
    candle
        .getConfigurator()
        .apply(new CANdleFeaturesConfigs().withVBatOutputMode(VBatOutputModeValue.Off));
    candle.setControl(
        flowAnimation
            .withLEDStartIndex(START)
            .withLEDEndIndex(LEFT_END)
            .withColor(ORANGE)
            .withSlot(0));
    candle.setControl(
        flowAnimation
            .withLEDStartIndex(RIGHT_START)
            .withLEDEndIndex(RIGHT_END)
            .withColor(ORANGE)
            .withSlot(1));
  }
